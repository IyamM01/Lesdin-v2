                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm">
                            <div class="flex items-center gap-2">
                                <a href="{{ route('admin.siswa.show', $siswa->id) }}" class="inline-flex items-center px-3 py-1.5 bg-[#3C5148] hover:bg-[#3C5148] text-white text-xs font-medium rounded-lg transition">
