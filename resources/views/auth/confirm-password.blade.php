...
<head>
  ...
  <title>Konfirmasi Password - SMK NEGERI 2 DEPOK SLEMAN</title>
  ...
  <div class="flex-1 bg-gray-50 flex items-center justify-center p-4 lg:p-8">
    <div class="w-full max-w-md">
      ...
      <div class="text-start mb-6 lg:mb-8">
        <h2 class="text-2xl lg:text-3xl font-bold text-[#3C5148] mb-2">Konfirmasi Password</h2>
        <p class="text-sm lg:text-base text-[#1B2727]">Masukkan password untuk melanjutkan.</p>
      </div>
      ...
      <form method="POST" action="{{ route('password.confirm') }}" class="space-y-4 lg:space-y-6">
        @csrf
